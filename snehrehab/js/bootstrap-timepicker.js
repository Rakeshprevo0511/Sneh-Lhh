  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      case 'modal':
        ...
        break;
      case 'dropdown':
        template = '<div class="bootstrap-timepicker dropdown-menu dropdown-menu-2">'+ templateContent +'</div>';
        break;
      }
    ...
    updateWidget: function() {
      ...
      if (this.showInputs) {
        this.$widget.find('input.bootstrap-timepicker-hour').val(this.hour.toString().length === 1 ? '0' + this.hour : this.hour);
        ...
        this.$widget.find('span.bootstrap-timepicker-hour').text(this.hour.toString().length === 1 ? '0' + this.hour : this.hour);
