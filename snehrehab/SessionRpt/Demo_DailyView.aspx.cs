...
{
    public partial class Demo_DailyView : System.Web.UI.Page
    {
        ...
        {
            ReportGV.PageIndex = 0; SearchDataDemo();
        ...
        public string GetAction(string UniqueID)
        {
            if (isSuperAdmin)
                ...
                return "<a href=\"/SessionRpt/Demo_DailyRpt.aspx?record=" + UniqueID + "\">View/Edit</a> &nbsp;";
        }
    }
}