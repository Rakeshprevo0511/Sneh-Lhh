...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div class="grid">
        <div class="grid-title">
            ...
            <a href="/SessionRpt/RevalView.aspx" class="btn btn-primary">View List</a>
            </div>
        </div>
        <div class="grid-content" style="">
            ...
            <div class="formRow">
                <div class="span12"> <asp:HiddenField ID="hfdTabs" runat="server" ClientIDMode="Static" />
            ...
            <div class="clearfix">
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="SAVE&NEXT" />
            </div>
            </div>
        </div>
    </div>
