...
{
    public partial class Demo_RevalView : System.Web.UI.Page
    {
        ...
        private void DemoSearchData()
        {
            ...
            ReportGV.DataSource = RDB.DemoSearchReval(txtSearch.Text.Trim(), _fromDate, _uptoDate, true);
            ReportGV.DataBind();
        ...
        public string GetAction(string UniqueID)
        {
            if (isSuperAdmin)
                ...
                return "<a href=\"/SessionRpt/Demo_RevalRpt.aspx?record=" + UniqueID + "\">View/Edit</a> &nbsp;";
        } 
    }
}