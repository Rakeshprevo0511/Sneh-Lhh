...
{
    public partial class Demo_PreScreenView : System.Web.UI.Page
    {
        ...
        public string SessionRptLink(string _uniqueID, string _isUpdated)
        {
            ...
            if (isUpdated > 0)
            {
                return "<a href=\"/SessionRpt/CreateRpt.ashx?type=6&record=" + _uniqueID + "\" target=\"_blank\" class=\"btn-print btn-success\">Print</a>";
            }
            return "Pending";
        }
        ...
        public string GetAction(string UniqueID)
        {
            if (isSuperAdmin)
                ...
                return "<a href=\"/SessionRpt/Demo_PreScreenRpt.aspx?record=" + UniqueID + "\">View/Edit</a> &nbsp;";
        }
    }
}