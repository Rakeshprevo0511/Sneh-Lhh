...
{
    public partial class PreConsultationView : System.Web.UI.Page
    {
        ...
        private void SearchData()
        {
            ...
            ReportGV.DataSource = RDB.Search(_loginID, txtSearch.Text.Trim(), _fromDate, _uptoDate, true);
            ReportGV.DataBind();
        ...
        public string SessionRptLink(string _uniqueID, string _isUpdated)
        {
            ...
            if (isUpdated > 0)
            {
                return "<a href=\"/SessionRpt/CreateRpt.ashx?type=7&record=" + _uniqueID + "\" target=\"_blank\" class=\"btn-print btn-success\">Print</a>";
            }
            return "Pending";
        }
        ...
        public string GetAction(string UniqueID)
        {
            if (isSuperAdmin)
                ...
                return "<a href=\"/SessionRpt/PreConsultationRpt.aspx?record=" + UniqueID + "\">View/Edit</a> &nbsp;";
        }
        ...
        protected void btnResearch_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.Append("<tr><th>SR NO</th><th>FULL NAME</th><th>Age</th><th>Gender</th><th>Expected Date of delivery</th><th>which school does your child study in?</th><th>Which grade?</th><th>Mothers age</th><th>Fathers age </th><th>Diagnosis </th><th>Chief concerns at home</th>" +
                    "<th>chief concers at school</th><th>Chief concerns at social gatherings </th><th>Consanguinity</th><th>Years of marriage</th><th>Family Structure</th><th>Conception </th><th>Planning of conception  </th><th>Sibling history </th><th>interparental relationship</th><th>Parent child relationship</th><th>Family relocation</th><th>screen time of the child </th>" +
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Consanguinity"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["YearsMarriage"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["FamilyStructure"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Conception"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["PlanningConception"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["InterParentalRelation"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["ParentChildRelation"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["InterSiblingRelation"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["FamilyRelocation"].ToString() + "</td>");
                    ...
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["CheckMental"].ToString() + "</td>");
                    ...
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["delivery"].ToString() + "</td>");
                    ...
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["GestationalBirthAge"].ToString() + "</td>");
                    ...
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Brushing"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Bathing"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Toileting"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Dressing"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Eating"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Ambulation"].ToString() + "</td>");
                    html.Append("<td style=\"vertical-align:top;\">" + dt.Rows[i]["Transfers"].ToString() + "</td>");
