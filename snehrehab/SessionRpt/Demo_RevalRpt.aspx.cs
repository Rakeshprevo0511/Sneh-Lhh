...
{
    public partial class Demo_RevalRpt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            //_cancelUrl = "/SessionRpt/Demo_RevalView.aspx";
            //if (_appointmentID > 0)
            //{
            //    if (!IsPostBack)
            //    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //    // Response.Redirect(ResolveClientUrl("~" + _cancelUrl), true);
            //    Response.Redirect(ResolveClientUrl("~/SessionRpt/Demo_RevalRpt.aspx?record=" + Request.QueryString["record"]), true);
            //}
            //else
            //{
