...
{
    public partial class Demo_NdtView : System.Web.UI.Page
    {
        int _loginID = 0; bool isSuperAdmin = false; string Demo = string.Empty;
        ...
        {
            ReportGV.PageIndex = e.NewPageIndex; SearchDataDemo();
        }

        private void SearchDataDemo()
        {
            ...
            ReportGV.DataSource = RDB.SearchDemo(txtSearch.Text.Trim(), _fromDate, _uptoDate, true);
            ReportGV.DataBind();
        ...
        public string GetAction(string UniqueID)
        {
            if (isSuperAdmin)
                ...
                return "<a href=\"/SessionRpt/Demo_NdtRpt.aspx?record=" + UniqueID + "\">View/Edit</a> &nbsp;";
        }
    }
}