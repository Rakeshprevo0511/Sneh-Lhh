...
{
    public partial class Demo_PreScreenRpt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            //_cancelUrl = "/SessionRpt/PreScreenView.aspx";
            //if (_appointmentID > 0)
            //{
            //    if (!IsPostBack)
            //    {
        ...
        private void LoadForm()
        {
            ...
            //SnehBLL.ReportPreScreenMst_Bll RDB = new SnehBLL.ReportPreScreenMst_Bll();
            ...
            //        }
            //        txtPrint.Value = "<a target='_blank' href='/SessionRpt/CreateRpt.ashx?type=6&record=" + Request.QueryString["record"].ToString() + "' class='btn btn-primary'>Print</a>&nbsp;";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //    //Response.Redirect(ResolveClientUrl("~" + _cancelUrl), true);
            //    Response.Redirect(ResolveClientUrl("~/SessionRpt/Demo_PreScreenRpt.aspx?record=" + Request.QueryString["record"]), true);
            //}
            //else
            //{
