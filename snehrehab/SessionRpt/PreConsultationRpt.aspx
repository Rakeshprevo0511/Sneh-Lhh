<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="PreConsultationRpt.aspx.cs" Inherits="snehrehab.SessionRpt.PreConsultationRpt" %>
...
<div class="grid">
        <div class="grid-title">
            <div class="pull-left">
                Pre Consultation Report :</div>
            <div class="pull-right">
            <a href="/SessionRpt/PreConsultationView.aspx" class="btn btn-primary">View List</a>
            </div>
        </div>
        <div class="grid-content" style="">
            ...
            <div class="formRow">
                <div class="span12">
                            ...
                            <ContentTemplate>
                                <div style="margin-top: 20px; margin-bottom: 20px;">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span9">
                                            <div class="control-label">
                                                <asp:CheckBox ID="His_FamilyHistory_1" runat="server" onclick="His_FamilyHistory_1_Click();"
                                                    CssClass="checkboes" Text=" Consanguineous" />
                                                <asp:CheckBox ID="His_FamilyHistory_2" runat="server" onclick="His_FamilyHistory_2_Click();"
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span9">
                                            <div class="control-label">
                                                <asp:CheckBox ID="His_FamilyStru_1" runat="server" onclick="His_FamilyStru_1_Click();"
                                                    CssClass="checkboes" Text=" Nuclear" />
                                                <asp:CheckBox ID="His_FamilyStru_2" runat="server" onclick="His_FamilyStru_2_Click();"
                                            ...
                                            <div class="control-group">
                                                <div class="formRow">
                                                    <div class="span5">
                                                        ...
                                                        <asp:TextBox ID="His_InterParental" runat="server" CssClass="span5" TextMode="MultiLine"></asp:TextBox>
                                                    </div>
                                                    <div class="span5">
                                                        <div class="control-label">
                                                            Parent child relationship :
                                                        </div>
                                                        <asp:TextBox ID="His_ParentalChild" runat="server" CssClass="span5" TextMode="MultiLine"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span5">
                                            <div class="control-label">
                                                <asp:CheckBox ID="His_EmotionalAbus_1" runat="server" onclick="His_EmotionalAbus_1_Click();"
                                                    CssClass="checkboes" Text=" Yes" />
                                                <asp:CheckBox ID="His_EmotionalAbus_2" runat="server" onclick="His_EmotionalAbus_2_Click();"
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span9">
                                            <div class="control-label">
                                                <asp:CheckBox ID="His_FamilyRelocation_1" runat="server" onclick="His_FamilyRelocation_1_Click();"
                                                    CssClass="checkboes" Text=" Yes" />
                                                <asp:CheckBox ID="His_FamilyRelocation_2" runat="server" onclick="His_FamilyRelocation_2_Click();"
                                                    CssClass="checkboes" Text=" No" />
                                                <script type="text/javascript">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span9">
                                            <asp:TextBox ID="His_PrimaryCareGiver" runat="server" CssClass="span9"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        <div class="span11">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span3">
                                            <div class="control-label">
                                                <asp:CheckBox ID="His_MaternalHistory_1" runat="server" onclick="His_MaternalHistory_1_Click();"
                                                    CssClass="checkboes" Text=" 1st Child" />
                                                <asp:CheckBox ID="His_MaternalHistory_2" runat="server" onclick="His_MaternalHistory_2_Click();"
                                        ...
                                        <div class="span3">
                                            <asp:TextBox ID="His_MaternalHistory_3" runat="server" class="span3"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        <div class="span2">
                                        ...
                                        <div class="span4">
                                            <div class="control-label">
                                                <asp:CheckBox ID="His_AnyHistoryOf_1" runat="server" onclick="His_AnyHistoryOf_1_Click();"
                                                    CssClass="checkboes" Text=" Diabetes" />
                                                <asp:CheckBox ID="His_AnyHistoryOf_2" runat="server" onclick="His_AnyHistoryOf_2_Click();"
                                                    CssClass="checkboes" Text=" Hypertension" />
                                                <asp:CheckBox ID="His_AnyHistoryOf_3" runat="server" onclick="His_AnyHistoryOf_3_Click();"
                                        ...
                                        <div class="span3">
                                            <asp:TextBox ID="His_AnyHistoryOf_4" runat="server" class="span3"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        <div class="span11">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span3">
                                            <div class="control-label">
                                                <asp:CheckBox ID="PreNatal_AnyComplication_1" runat="server" onclick="PreNatal_AnyComplication_1_Click();"
                                                    CssClass="checkboes" Text=" Yes" />
                                                <asp:CheckBox ID="PreNatal_AnyComplication_2" runat="server" onclick="PreNatal_AnyComplication_2_Click();"
                                                    CssClass="checkboes" Text=" No" />
                                                <script type="text/javascript">
                                        ...
                                        <div class="span3">
                                            <asp:TextBox ID="PreNatal_Complications" runat="server" CssClass="span3"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                    </div>
                            ...
                            <ContentTemplate>
                                <div style="margin-top: 20px; margin-bottom: 20px;">
                                    <div class="formRow">
                                        ...
                                        <div class="span3">
                                            <div class="control-label">
                                                <asp:CheckBox ID="BirthHis_Terms_1" runat="server" onclick="BirthHis_Terms_1_Click();"
                                                    CssClass="checkboes" Text=" Full Term" />
                                                <asp:CheckBox ID="BirthHis_Terms_2" runat="server" onclick="BirthHis_Terms_2_Click();"
                                        ...
                                        <div class="span3">
                                            <asp:TextBox ID="BirthHis_TermWeek" runat="server" class="span3"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        <div class="span2">
                                        ...
                                        <div class="span9">
                                            <div class="control-label">
                                                <asp:CheckBox ID="BirthHis_Delivery_1" runat="server" onclick="BirthHis_Delivery_1_Click();"
                                                    CssClass="checkboes" Text=" Normal" />
                                                <asp:CheckBox ID="BirthHis_Delivery_2" runat="server" onclick="BirthHis_Delivery_2_Click();"
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span9">
                                            <div class="control-label">
                                                <asp:TextBox ID="BirthHis_LabourTotal" runat="server" CssClass="span5"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        ...
                                        <div class="span9">
                                            <div class="control-label">
                                                <asp:CheckBox ID="BirthHis_LabourDiff_1" runat="server" onclick="BirthHis_LabourDiff_1_Click();"
                                                    CssClass="checkboes" Text=" Yes" />
                                                <asp:CheckBox ID="BirthHis_LabourDiff_2" runat="server" onclick="BirthHis_LabourDiff_2_Click();"
                                                    CssClass="checkboes" Text=" No" />
                                                <script type="text/javascript">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span6">
                                            <div class="control-label">
                                                <asp:TextBox ID="BirthHis_LabourProb" runat="server" CssClass="span4"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        ...
                                        <div class="span6">
                                            <div class="control-label">
                                                <asp:TextBox ID="BirthHis_Aneshthesia" runat="server" CssClass="span4"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span9">
                                            <div class="control-label">
                                                <asp:CheckBox ID="Other_CIAB_1" runat="server" onclick="Other_CIAB_1_Click();" CssClass="checkboes"
                                                    Text=" Yes" />
                                                <asp:CheckBox ID="Other_CIAB_2" runat="server" onclick="Other_CIAB_2_Click();" CssClass="checkboes"
                                                    Text=" No" />
                                                <script type="text/javascript">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span3">
                                            <asp:TextBox ID="Other_BirthWeight" runat="server" CssClass="span3"></asp:TextBox>
                                        </div>
                                        <div class="span4">
                                            <div class="control-label">
                                                <asp:CheckBox ID="Other_SGA_AGA_1" runat="server" onclick="Other_SGA_AGA_1_Click();"
                                                    CssClass="checkboes" Text=" SGA" />
                                                <asp:CheckBox ID="Other_SGA_AGA_2" runat="server" onclick="Other_SGA_AGA_2_Click();"
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span3">
                                            <asp:TextBox ID="Other_APGAR_Score" runat="server" CssClass="span3"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                    </div>
                            ...
                            <ContentTemplate>
                                <div style="margin-top: 20px; margin-bottom: 20px;">
                                    <div class="formRow">
                                        ...
                                        <div class="span2">
                                            <div class="control-label">
                                                <asp:CheckBox ID="NICU_1" runat="server" onclick="NICU_1_Click();" CssClass="checkboes"
                                                    Text=" Yes" />
                                                <asp:CheckBox ID="NICU_2" runat="server" onclick="NICU_2_Click();" CssClass="checkboes"
                                                    Text=" No" />
                                                <script type="text/javascript">
                                        ...
                                        <div class="span6">
                                            <div class="">
                                                ...
                                                <div class="span4">
                                                    <asp:TextBox ID="NICU_Duration" runat="server" CssClass="span4"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="">
                                                <div class="control-label span1">
                                                ...
                                                <div class="span4">
                                                    <asp:TextBox ID="NICU_Reason" runat="server" CssClass="span4"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:TextBox ID="DischargedOnWhichDay" runat="server" CssClass="span5"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:TextBox ID="ChildTakingMotherFeeds" runat="server" CssClass="span5"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:TextBox ID="AnyOtherRelevantMedicalHistory" runat="server" CssClass="span5"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:TextBox ID="MedicalTimeLine" runat="server" CssClass="span5"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                            ...
                            <ContentTemplate>
                                <div style="margin-top: 20px; margin-bottom: 20px;">
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:CheckBox ID="HowWasBabyAtHome_1" runat="server" CssClass="checkboes" Text=" Comfortable" />
                                                <asp:CheckBox ID="HowWasBabyAtHome_2" runat="server" CssClass="checkboes" Text=" Irritated" />
                                                <asp:CheckBox ID="HowWasBabyAtHome_3" runat="server" CssClass="checkboes" Text=" Cranky" />
                                                <asp:CheckBox ID="HowWasBabyAtHome_4" runat="server" CssClass="checkboes" Text=" Playful" />
                                                <asp:CheckBox ID="HowWasBabyAtHome_5" runat="server" CssClass="checkboes" Text=" Passive" />
                                                <asp:CheckBox ID="HowWasBabyAtHome_6" runat="server" CssClass="checkboes" Text=" Calm" />
                                                <asp:CheckBox ID="HowWasBabyAtHome_7" runat="server" CssClass="checkboes" Text=" Well Connected" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:CheckBox ID="WasHeFeedingWell_1" runat="server" onclick="WasHeFeedingWell_1_Click();"
                                                    CssClass="checkboes" Text=" Yes" />
                                                <asp:CheckBox ID="WasHeFeedingWell_2" runat="server" onclick="WasHeFeedingWell_2_Click();"
                                                    CssClass="checkboes" Text=" No" />
                                                <script type="text/javascript">
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:CheckBox ID="WasHeSleepingWell_1" runat="server" onclick="WasHeSleepingWell_1_Click();"
                                                    CssClass="checkboes" Text=" Yes" />
                                                <asp:CheckBox ID="WasHeSleepingWell_2" runat="server" onclick="WasHeSleepingWell_2_Click();"
                                                    CssClass="checkboes" Text=" No" />
                                                <script type="text/javascript">
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="AnyDelay_MedicalEvent_Symptoms" runat="server" CssClass="span10"
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="WhoWasTheFirstNotice" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="WhatWasDoneForTheSame" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="ChildStartedToHeadHold" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="WasItOnTimeOrDelayed" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="CloselyInvolvedWithChild" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="ReleventMedicalTimeline" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="ChildChooseToUseFreeTime" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="ObservationsDuringFreePlay" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Brushing_Dependant" runat="server" onclick="Brushing_Dependant_Click  ();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Brushing_Independant" runat="server" onclick="Brushing_Independant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Brushing_Assisted" runat="server" onclick="Brushing_Assisted_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <script type="text/javascript">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Toileting_Dependant" runat="server" onclick="Toileting_Dependant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Toileting_Independant" runat="server" onclick="Toileting_Independant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Toileting_Assisted" runat="server" onclick="Toileting_Assisted_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <script type="text/javascript">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Bathing_Dependant" runat="server" onclick="Bathing_Dependant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Bathing_Independant" runat="server" onclick="Bathing_Independant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Bathing_Assisted" runat="server" onclick="Bathing_Assisted_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <script type="text/javascript">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Dressing_Dependant" runat="server" onclick="Dressing_Dependant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Dressing_Independant" runat="server" onclick="Dressing_Independant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Dressing_Assisted" runat="server" onclick="Dressing_Assisted_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <script type="text/javascript">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Feeding_Dependant" runat="server" onclick="Feeding_Dependant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Feeding_Independant" runat="server" onclick="Feeding_Independant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Feeding_Assisted" runat="server" onclick="Feeding_Assisted_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <script type="text/javascript">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Ambulation_Dependant" runat="server" onclick="Ambulation_Dependant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Ambulation_Independant" runat="server" onclick="Ambulation_Independant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Ambulation_Assisted" runat="server" onclick="Ambulation_Assisted_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <script type="text/javascript">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="Transfer_Dependant" runat="server" onclick="Transfer_Dependant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Transfer_Independant" runat="server" onclick="Transfer_Independant_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="Transfer_Assisted" runat="server" onclick="Transfer_Assisted_Click();"
                                                                CssClass="checkboes" />
                                                        </td>
                                                        <script type="text/javascript">
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="DailyRoutine" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        <div class="span11">
                                            ...
                                            <div class="control-group">
                                                <asp:TextBox ID="Summary" runat="server" CssClass="span10" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="formRow">
                                        ...
                                        <div class="span8">
                                            <div class="control-label">
                                                <asp:CheckBox ID="EvaluationNeeded_1" runat="server" onclick="EvaluationNeeded_1_Click();"
                                                    CssClass="checkboes" Text=" NDT" />
                                                <asp:CheckBox ID="EvaluationNeeded_2" runat="server" onclick="EvaluationNeeded_2_Click();"
                                                    CssClass="checkboes" Text=" SI" />
                                                <asp:CheckBox ID="EvaluationNeeded_3" runat="server" onclick="EvaluationNeeded_3_Click();"
                                                    CssClass="checkboes" Text=" Both" />
                                                <asp:CheckBox ID="EvaluationNeeded_4" runat="server" onclick="EvaluationNeeded_4_Click();"
                                                    CssClass="checkboes" Text=" Ortho" />
                                                <asp:CheckBox ID="EvaluationNeeded_5" runat="server" onclick="EvaluationNeeded_5_Click();"
                                                    CssClass="checkboes" Text=" EIP" />
                                                <asp:CheckBox ID="EvaluationNeeded_6" runat="server" onclick="EvaluationNeeded_6_Click();"
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Cardiologist_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Cardiologist_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Cardiologist_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Cardiologist_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Orthopedist_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Orthopedist_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Orthopedist_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Orthopedist_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Psychologist_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Psychologist_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Psychologist_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Psychologist_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Psychiatrist_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Psychiatrist_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Psychiatrist_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Psychiatrist_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Opthalmologist_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Opthalmologist_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Opthalmologist_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Opthalmologist_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Speech_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Speech_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Speech_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Speech_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Pathologist_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Pathologist_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Pathologist_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Pathologist_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Occupational_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Occupational_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Occupational_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Occupational_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Physical_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Physical_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Physical_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Physical_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Audiologist_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Audiologist_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Audiologist_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Audiologist_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="ENT_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="ENT_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="ENT_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="ENT_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Chiropractor_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Chiropractor_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Chiropractor_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Chiropractor_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Other_Name" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Other_Date" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Other_Addr" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="Other_Phone" runat="server" CssClass="span3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                    ...
                    <div class="clearfix">
                        <asp:Button ID="Button1" runat="server" Text="SAVE&NEXT" OnClick="Button1_Click" />
                    </div>
                </div>
                <div class="clearfix">
                </div>
