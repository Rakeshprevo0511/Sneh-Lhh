...
{
    public partial class Demo_DailyRpt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            //_cancelUrl = "/SessionRpt/Demo_DailyView.aspx";
            //if (_appointmentID > 0)
            //{
            //    if (!IsPostBack)
            //    {
        ...
        private void LoadForm()
        {
            ...
            //    {
            //        Response.Redirect(ResolveClientUrl("~/SessionRpt/Demo_DailyRpt1.aspx?record=" + Request.QueryString["record"].ToString()), true); return;
            //    }
            //    else
            //    {
            //        Response.Redirect(ResolveClientUrl("~" + _cancelUrl), true); return;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //int i = RDB.Set(_appointmentID, txtSessionGoal.Text.Trim(), txtActivity.Text.Trim(), txtEquipments.Text.Trim(), _performanceID, _goalAssScaleID,
            //    txtLongTerm.Text.Trim(), txtShortTerm.Text.Trim(), txtSuggestions.Text.Trim(), DateTime.UtcNow.AddMinutes(330), _loginID,
            ...
            //    Session[DbHelper.Configuration.messageTextSession] = "Demo Daily report saved successfully...";
