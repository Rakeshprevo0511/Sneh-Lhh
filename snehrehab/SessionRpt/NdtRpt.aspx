<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="NdtRpt.aspx.cs" Inherits="snehrehab.SessionRpt.NdtRpt" Title="" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="grid">
        <div class="grid-title">
            ...
            <a href="/SessionRpt/NdtView.aspx" class="btn btn-primary">View List</a>
            </div>
        </div>
        <div class="grid-content" style="">
            ...
            <ajaxToolkit:TabContainer ID="tb_Contents" runat="server">
                        ...
                        <div style="margin-top: 20px; margin-bottom: 20px;">
                            ...
                            <div class="formRow char-line-limiter">
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        <asp:TextBox ID="DataCollection_Investigation" runat="server" CssClass="span10"
                                            TextMode="MultiLine" Rows="8"></asp:TextBox>
                                    </div>
                                    <div class="clearfix"></div>
                                    <span class="char-limit-msg"></span>
                        ...
                        <div style="margin-top: 20px; margin-bottom: 20px;">
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Alignment :</div>
                                    <div class="span5">
                                        <asp:CheckBox ID="Posture_Alignment_Type_1" runat="server" onclick="Posture_Alignment_Type_1_Click()"
                                            CssClass="checkboes" Text=" Symmetrical" />
                                        <asp:CheckBox ID="Posture_Alignment_Type_2" runat="server" onclick="Posture_Alignment_Type_2_Click()"
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        1) Head :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Gen_Head" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        2) Shoulder :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Gen_Shoulder" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        4) Trunk :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Gen_Trunk" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        5) Pelvis :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Gen_Pelvis" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        6) Hips :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Gen_Hips" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        7) Knees :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Gen_Knees" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        8) Ankle/Feet :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Gen_Ankle_Feet" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        1) Neck :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Neck" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        2) Jaw :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Jaw" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        3) Lips :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Lips" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        4) Teeth :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Teeth" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        5) Tounue :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Tounge" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Palate :</div>
                                    <div class="span8">
                                        <asp:CheckBox ID="Posture_Stru_Palate_1" runat="server" onclick="Posture_Stru_Palate_1_Click()"
                                            CssClass="checkboes" Text=" High" />
                                        <asp:CheckBox ID="Posture_Stru_Palate_2" runat="server" onclick="Posture_Stru_Palate_2_Click()"
                                            CssClass="checkboes" Text=" Shallow" />
                                        <asp:CheckBox ID="Posture_Stru_Palate_3" runat="server" onclick="Posture_Stru_Palate_3_Click()"
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Mouth Posture :</div>
                                    <div class="span5">
                                        <asp:CheckBox ID="Posture_Stru_MouthPosture_1" runat="server" onclick="Posture_Stru_MouthPosture_1_Click()"
                                            CssClass="checkboes" Text=" Open" />
                                        <asp:CheckBox ID="Posture_Stru_MouthPosture_2" runat="server" onclick="Posture_Stru_MouthPosture_2_Click()"
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_ToungueMove" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Bite :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Bite" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Swallow :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Swallow" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Chew :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Chew" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Suck :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Suck" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_BaseSupport" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_CenterOfMass" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:CheckBoxList ID="Posture_Stru_StrategyForStability" runat="server" CssClass="checkbox span8" SelectionMode="Multiple">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_Anticipatory" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Stru_CounterBalance" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Impairment_Muscle" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Atrophy :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Impairment_Atrophy" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Hypertrophy :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Impairment_Hypertrophy" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Callosities :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_Impairment_Callosities" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Posture_GeneralPosture" runat="server" CssClass="span8" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="margin-top: 20px; margin-bottom: 20px;">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span5">
                                        <asp:CheckBox ID="Movement_TypeOf_1" runat="server" onclick="Movement_TypeOf_1_Click()"
                                            CssClass="checkboes" Text=" Ramp" />
                                        <asp:CheckBox ID="Movement_TypeOf_2" runat="server" onclick="Movement_TypeOf_2_Click()"
                                            ...
                                            <div class="row">
                                                <div class="span1">
                                                    ...
                                                    <div class="span2" style = "margin-left: 0;">
                                                        <asp:TextBox ID="Movement_Sagittal" runat="server" CssClass="span2"></asp:TextBox>
                                                </div>
                                                <div class="span1" style = "margin-left: 0;">
                                                    <asp:Label ID=Label1 runat="server" Text="Coronal"></asp:Label></div>
                                                    <div class="span2" style = "margin-left: 0;">
                                                        <asp:TextBox ID="Movement_Coronal" runat="server" CssClass="span2"></asp:TextBox>
                                                </div>
                                                <div class="span1" style = "margin-left: 0;">
                                                    <asp:Label ID=Label2 runat="server" Text="Transverse"></asp:Label></div>
                                                    <div class="span2">
                                                        <asp:TextBox ID="Movement_Transverse" runat="server" CssClass="span2"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                               <%--     <div class="span8">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    <div class="span2">
                                        Weight Shifts :</div>
                                    <div class="span8">
                                        <asp:TextBox ID="Movement_WeightShift" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Movement_LimbDissociation" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Movement_RangeSpeedOfMovements" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:CheckBoxList ID="Movement_Stability" runat="server" CssClass="checkboes">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:CheckBoxList ID="Movement_Overuse" runat="server" CssClass="checkboes">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Movement_Balance_Maintain" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Movement_Balance_During" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                            ...
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Movement_Accuracy_Upper" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="span11 formRow">
                                <div class="row">
                                    ...
                                    <div class="span8">
                                        <asp:TextBox ID="Movement_Accuracy_Lower" runat="server" CssClass="span8"></asp:TextBox>
                                    </div>
                                </div>
                            </div> 
                            <div class="formRow">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="Neuromotor_Recruitment_Initial" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Recruitment_Sustainance" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Recruitment_Termination" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Recruitment_Control" runat="server" CssClass="span3"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Type of contraction<br />Concentric<br />Isometric<br />Eccentric</td>
                                            <td><asp:TextBox ID="Neuromotor_Contraction_Initial" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Contraction_Sustainance" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Contraction_Termination" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Contraction_Control" runat="server" CssClass="span3"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Co-activation / Reciprocal inhibition</td>
                                            <td><asp:TextBox ID="Neuromotor_Coactivation_Initial" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Coactivation_Sustainance" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Coactivation_Termination" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Coactivation_Control" runat="server" CssClass="span3"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Type of Synergy</td>
                                            <td><asp:TextBox ID="Neuromotor_Synergy_Initial" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Synergy_Sustainance" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Synergy_Termination" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Synergy_Control" runat="server" CssClass="span3"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Stiffness(Static/Dynamic)</td>
                                            <td><asp:TextBox ID="Neuromotor_Stiffness_Initial" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Stiffness_Sustainance" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Stiffness_Termination" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Stiffness_Control" runat="server" CssClass="span3"></asp:TextBox></td>
                                        </tr>
                                        <tr>                                     
                                            <td>Extraneous Movement</td>
                                            <td><asp:TextBox ID="Neuromotor_Extraneous_Initial" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Extraneous_Sustainance" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Extraneous_Termination" runat="server" CssClass="span3"></asp:TextBox></td>
                                            <td><asp:TextBox ID="Neuromotor_Extraneous_Control" runat="server" CssClass="span3"></asp:TextBox></td>
                                        </tr>
                                    </tbody>
                                </table> 
                            </div>
                            ...
                            <div class="span11 formRow">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>TA</td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_TA_Right" runat="server" CssClass="span5"></asp:TextBox></td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_TA_Left" runat="server" CssClass="span5"></asp:TextBox></td> 
                                        </tr>
                                        <tr>
                                            <td>Hamstrings</td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Hamstring_Right" runat="server" CssClass="span5"></asp:TextBox></td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Hamstring_Left" runat="server" CssClass="span5"></asp:TextBox></td> 
                                        </tr>
                                        <tr>
                                            <td>Adductors</td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Adductor_Right" runat="server" CssClass="span5"></asp:TextBox></td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Adductor_Left" runat="server" CssClass="span5"></asp:TextBox></td> 
                                        </tr>
                                        <tr>
                                            <td>Hip Flexor Angle</td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Hip_Right" runat="server" CssClass="span5"></asp:TextBox></td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Hip_Left" runat="server" CssClass="span5"></asp:TextBox></td> 
                                        </tr>
                                        <tr>
                                            <td>Biceps</td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Biceps_Right" runat="server" CssClass="span5"></asp:TextBox></td>
                                            <td><asp:TextBox ID="OtherTest_Tardieus_Biceps_Left" runat="server" CssClass="span5"></asp:TextBox></td> 
                                        </tr>
                                    </tbody>
                                </table>
                            </div> 
               ...
               <%-- <ajaxToolkit:TabPanel ID="tb_Report8" runat="server" HeaderText="Regulatory">
                        ...
                        <div style="margin-top: 20px; margin-bottom: 20px;">
                            ...
                            <div class="formRow">
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        <asp:TextBox ID="Respiratory_ChestExcursion" runat="server" CssClass="span10" TextMode="MultiLine"
                                            Rows="3"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="clearfix">
                ...
                <div class="clearfix">
                <asp:Button ID="Button1" CssClass="buttonClass" runat="server" align="center" Font-Bold="True" OnClick="Button1_Click" width="200px" Text="SAVE&NEXT" ClientIDMode="Static" />
            </div>
            <div class="clearfix">
            </div>
            </div>
