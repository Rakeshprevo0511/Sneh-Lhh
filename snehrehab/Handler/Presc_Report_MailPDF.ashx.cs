...
{
    /// <summary>
    /// Summary description for Presc_Report_MailPDF
    /// </summary>
    public class Presc_Report_MailPDF : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            PreScreenReport evnt = jsonSerializer.Deserialize<PreScreenReport>(requestBody);
            ...
            {
                string _fileName = DbHelper.Configuration.MakeValidFilename("Pre-Consultation Report - " + ds.Tables[0].Rows[0]["FullName"].ToString()) + ".pdf";
                ...
                */
                ...
                mail = AM.sendAttachment(mailid, "", "Pre-Consultation Report", result_sheet);
                if (mail)
                {
                    DbHelper.SqlDb db = new DbHelper.SqlDb();
                    SqlCommand cmd = new SqlCommand("UPDATE Report_PreConsultMst SET MailSend=CAST('True'AS BIT) WHERE AppointmentID=@AppointmentID");
