<%@ Page Language="C#"  MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="PrintReceiptCas_Cred.aspx.cs" Inherits="snehrehab.Member.PrintReceiptCas_Cred" %>
    ...
    <div class="grid">
        ...
        <div class="grid-content">
            ...
            <asp:GridView ID="BookingGV" runat="server" CssClass="table table-bordered" 
                ...
                <asp:TemplateField HeaderText="HOSPITAL RECEIPT NO."><ItemTemplate><%# GetReceipt(Eval("ReceiptPrefix").ToString(),Eval("ReceiptNo").ToString()) %></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="HOSPITAL RECPT.ID."><ItemTemplate><%# GetTxnNo(Eval("ReceiptType").ToString(),Eval("TableID").ToString(),Eval("FiscalDate").ToString()) %></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="HOSPITAL BOOKING DATE"><ItemTemplate><%# FORMATDATE(Eval("HospitalReceiptDate").ToString())%></ItemTemplate></asp:TemplateField>                   
                <asp:BoundField HeaderText="PACKAGE CODE" DataField="Remarks"/> 
