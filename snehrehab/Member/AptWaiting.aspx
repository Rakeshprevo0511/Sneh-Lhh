<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Member/Site.master" CodeBehind="AptWaiting.aspx.cs" Inherits="snehrehab.Member.AptWaiting" %>
        ...
        <div class="grid-title">
            <div class="pull-left">
             ...
             <div class="pull-right">
                <a href='/Member/AptWaitings.aspx' class="btn btn-primary">View List</a>
            </div>
        </div>
