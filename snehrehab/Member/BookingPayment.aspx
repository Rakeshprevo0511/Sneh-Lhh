<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" Inherits="Member_BookingPayment" Title="" Codebehind="BookingPayment.aspx.cs" %>
        ...
        <div class="grid-content">
            ...
            <asp:GridView ID="PatientGV" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="custome-pagination"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="BOOK DATE"><ItemTemplate><%# FORMATDATE(Eval("PayDate").ToString())%></ItemTemplate><HeaderStyle Width="95px" /></asp:TemplateField>
                    ...
                    <asp:BoundField HeaderText="PATIENT TYPE" DataField="PatientType" HeaderStyle-Width="125px" />
                    <asp:BoundField HeaderText="HEAD" DataField="LedgerHead" />
                    <asp:BoundField HeaderText="REMARK" DataField="Remarks" />
                    <asp:BoundField HeaderText="AMOUNT" DataField="CreditAmt" />
                    <asp:TemplateField HeaderText="ACTION">
                        <ItemTemplate>
                            <a href="javascript:;" data-toggle="modal" data-target="#myModal" onclick='LoadPayment("<%#Eval("UniqueID") %>", <%#Eval("CreditAmt") %>);'>Pay</a>
                        </ItemTemplate>
                ...
                <div class="modal-body">
                    <asp:UpdatePanel ID="UpdatePayBlock" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="formRow">
                                <div class="span5" style="margin: 0px;">
                                    <span class="span2"><b>Bank Name:</b></span>
                                    <div class="control-group">
                                        <div class="span2">
                                            <asp:DropDownList ID="txtPaymentBankName" runat="server" CssClass="chzn-select span3">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="formRow">
                                    <div class="span5" style="margin: 0px;">
                                        <span class="span2"><b>Bank Branch:</b></span>
                                        <div class="control-group">
                                            <div class="span2">
                                                <asp:TextBox ID="txtBankBranch" runat="server" CssClass="span3"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                ...
                                <div class="formRow">
                                    <div class="span5" style="margin: 0px;">
                                        <span class="span2"><b>Cheque No.:</b></span>
                                        <div class="control-group">
                                            <div class="span2">
                                                <asp:TextBox ID="txtChequeNo" runat="server" CssClass="span3"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                            ...
                            <div class="formRow">
                                <div class="span5" style="margin: 0px;">
                                    <span class="span2"><b>Cheque Date:</b></span>
                                    <div class="control-group">
                                        <div class="span2">
                                            <asp:TextBox ID="txtPaymentChequeDate" runat="server" CssClass="span2 my-datepicker"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="clearfix">
