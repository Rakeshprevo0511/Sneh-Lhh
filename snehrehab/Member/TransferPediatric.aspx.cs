...
{
    public partial class TransferPediatric : System.Web.UI.Page
    {
        int _loginID = 0; int _patientID = 0; int _patientTypeID = 2; public string _headerText = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (_patientID > 0) { _headerText = "Edit TransferPediatric Registration"; } else { _headerText = "New TransferPediatric Registration"; }
        ...
        private void LoadPatient()
        {
            ...
            if (PD != null && (PD.PatientTypeID == _patientTypeID || PD.PatientTypeID == 3))
            {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            bool isEnquiryPatient = false; SnehBLL.PatientMast_Bll PB = new SnehBLL.PatientMast_Bll();
            if (_patientID > 0)
            {
                int PatientTypeID = PB.PatientType(_patientID);
                if (PatientTypeID == 3)
                {
                    isEnquiryPatient = true;
                }
            }
            ...
            int i = PB.Transfer_PatientSet(PD);
