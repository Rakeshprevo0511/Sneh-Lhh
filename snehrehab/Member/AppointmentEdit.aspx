<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="AppointmentEdit.aspx.cs" Inherits="snehrehab.Member.AppointmentEdit" %>
            ...
            <div class="formRow">
                <div class="span6">
                    ...
                    <div class="control-group">
                        ...
                        &nbsp;
                        <asp:LinkButton ID="btnSaveNew" runat="server" Text="Save & New" CssClass="btn btn-danger" OnClick="btnSaveNew_Click" Visible="False" OnClientClick="ShowBlakLoader('black_loader_save');DisableOnSubmit(this);"></asp:LinkButton>
                    </div>
                </div>
                <div class="clearfix">
                </div>
