<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" Inherits="Member_DoctorDr" Title="" Codebehind="DoctorDr.aspx.cs" %>
        ...
        <div class="grid-content">
            ...
            <asp:GridView ID="ReportGV" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="custome-pagination"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="SESSION AMT"><ItemTemplate><%#Eval("AppointmentAmt")%></ItemTemplate></asp:TemplateField>
                    <asp:TemplateField HeaderText="NET AMT"><ItemTemplate><%#Eval("NetAmt")%></ItemTemplate></asp:TemplateField>
                    <%--<asp:TemplateField HeaderText="DR. AMT"><ItemTemplate><%#Eval("DebitAmt")%></ItemTemplate></asp:TemplateField>--%>
