<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" Inherits="Member_Supports" Title="" Codebehind="Supports.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="grid">
        ...
        <div class="grid-content">
            <div class="formRow">
                <asp:TextBox ID="txtEmployee" runat="server" placeholder="Full Name"></asp:TextBox>
            ...
            <asp:GridView ID="TicketGV" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="custome-pagination"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ACTION"><ItemTemplate><a href='../Member/Supporte.aspx?record=<%#Eval("UniqueID")%>'>Edit</a></ItemTemplate><HeaderStyle Width="50px" /><ItemStyle CssClass="text-center" /></asp:TemplateField>
                </Columns>
            </asp:GridView>
        </div>
    </div>
