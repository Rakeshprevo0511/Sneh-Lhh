<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="UserActs.aspx.cs" Inherits="snehrehab.Member.UserActs" Title="" %>
    ...
    <div class="grid">
        ...
        <div class="grid-content">
            <div class="formRow">
                ...
                <asp:DropDownList ID="txtUsers" runat="server" CssClass="chzn-select span4"></asp:DropDownList>
                </div>
