<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" Inherits="Member_Appointments" Title="" CodeBehind="Appointments.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="grid">
        ...
        <div class="grid-content">
            <div class="formRow">
                ...
                <div class="pull-left" style="display:inline-block;margin-right:5px;">
                    ...
                    <asp:DropDownList ID="txtduraton" runat="server" CssClass="input-medium chzn-select span2"  >
                        <asp:ListItem Value="-1">Duration</asp:ListItem>
            ...
            <asp:GridView ID="AppointmentGV" runat="server"  AutoGenerateColumns="False" CssClass="table table-bordered table-responsive"  ShowFooter="true" 
                onrowdatabound="AppointmentGV_RowDataBound">
                <EmptyDataTemplate>No records found...</EmptyDataTemplate>
                <Columns>
                <asp:TemplateField HeaderText="SR NO"><ItemTemplate><%# Eval("RowIndex") %></ItemTemplate><HeaderStyle Width="40px"/></asp:TemplateField>
