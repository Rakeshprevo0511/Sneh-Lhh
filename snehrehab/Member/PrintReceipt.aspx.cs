...
namespace snehrehab.Member
{
    public partial class PrintReceipt : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            SqlCommand cmd = new SqlCommand("Receipt_PrintSearch_ALL"); cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.Append("<tr><th>SR NO</th><th>FULL NAME</th><th>RECEIPT NO.</th><th>AMOUNT</th><th>RECEIPT DATE</th><th>CHQ. / ONLINE NO.</th><th>BOOKING DATE</th><th>TRANSACTION DATE</th><th>CANCEL</th><th>REMARK</th></tr>");
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (dtCq.Rows.Count > 0)
                    {
                        for (int pt = 0; pt < dtCq.Rows.Count; pt++)
                        {
                            ...
                            if (PayMode == 3)
                            {
                                ...
                                {
                                    chequeDetail += "."; chequeDetail = chequeDetail.Replace(Environment.NewLine, "");
                                    //hasChqueDetail = true;
                                }
                                break;
                            }
                    ...
                    html.Append("<td style=\"vertical-align:top;\">" + FORMATDATE(dt.Rows[i]["TransactionDate"].ToString()).ToString() + "</td>");
