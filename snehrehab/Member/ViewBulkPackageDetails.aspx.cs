...
namespace snehrehab.Member
{
    ...
    public partial class ViewBulkPackageDetails : System.Web.UI.Page
    {
        int _loginID = 0; bool isSuperAdmin = false; int _BulkID = 0;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    if (!int.TryParse(Request.QueryString["record"], out _BulkID))
                    {
                ...
                else
                {
                    ...
                    Response.Redirect("/Member/PackageBulks.aspx");
                }
                hfBulkBookingID.Value = _BulkID.ToString();
                LoadData();
            }
        ...
        private void LoadData()
        {
            ...
            DataTable dt = DB.GetBulkPacakgeUsage(_BulkID);
        ...
        {
            _BulkID = Convert.ToInt32(hfBulkBookingID.Value);
            SnehBLL.PatientPackage_Bll DB = new SnehBLL.PatientPackage_Bll();
            DataTable dt = DB.GetBulkPacakgeUsage(_BulkID);
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                string packageAmount = SafeStr(row["TotalPackageAmount"]);
