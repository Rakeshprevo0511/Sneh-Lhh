<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="TransferAdult.aspx.cs" Inherits="snehrehab.Member.TransferAdult" %>
                        ...
                        <div style="margin-top: 20px; margin-bottom: 20px;">
                            ...
                            <div class="formRow">
                                <div class="span6">
                                    ...
                                    <div class="control-group">
                                        <asp:LinkButton ID="btnNext1" runat="server" CssClass="btn btn-danger" OnClientClick="DisableOnSubmit(this);"
                                            OnClick="btnNext1_Click"> Next </asp:LinkButton>
                                    </div>
                                </div>
                                <div class="clearfix">
                                </div>
                        ...
                        <div style="margin-top: 20px; margin-bottom: 20px;">
                            <div class="formRow">
                                <div class="span6">
                                    ...
                                    <div class="control-group">
                                        <asp:DropDownList ID="txtAdultCase" runat="server" CssClass="chzn-select span4">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="span6">
