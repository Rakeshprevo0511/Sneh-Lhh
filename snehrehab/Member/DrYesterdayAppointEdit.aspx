<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="DrYesterdayAppointEdit.aspx.cs" Inherits="snehrehab.Member.DrYesterdayAppointEdit" %>
    ...
    <div class="grid">
        <div class="grid-title">
            ...
            <div class="pull-right">
                <a href="/Member/DrYesterdayAppoint.aspx" class="btn btn-primary">View List</a>
            </div>
        </div>
            ...
            <div class="formRow">
                <div class="span12">
                    ...
                    <div class="control-group">
                        ...
                        &nbsp;
                        <a href="/Member/DrYesterdayAppoint.aspx" class="btn btn-default">Cancel</a>
                    </div>
                </div>
                <div class="clearfix">
                </div>
