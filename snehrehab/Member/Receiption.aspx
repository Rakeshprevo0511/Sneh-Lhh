<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="Receiption.aspx.cs" Inherits="snehrehab.Member.Receiption" %>
                ...
                <div class="span6" id="upload" runat="server">
                    ...
                    <div class="control-group">
                        <%--<asp:Image ID="imgdegcert" runat="server"  style="width: 16%; border: 1px solid #000;"/>--%>
                         <asp:FileUpload ID="txtdegcer" runat="server"  CssClass="input-sm btn-file" style="margin-left:20px; width: 165px;" AllowMultiple="true" accept=".png,.jpg,.jpeg,.gif,.pdf"/>
                    </div>
                </div>
                <div class="clearfix">
                </div>
