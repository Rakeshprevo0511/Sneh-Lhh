<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="BirthDayUpComming.aspx.cs" Inherits="snehrehab.Member.BirthDayUpComming" %>
                ...
                <ajaxToolkit:TabPanel ID="tb_Patient" runat="server" HeaderText="Patient">
                    <ContentTemplate>
                        <div class="patient-div" style="margin-top: 20px; margin-bottom: 20px;">
                            ...
                            <div class="formRow">
                                <div class="span12">
                                    <asp:GridView ID="PatientGV" OnPageIndexChanging="PatientGV_PageIndexChanging" PageSize="30" AllowPaging="true" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False">
                                        <Columns>
                                            <%--<asp:TemplateField>
                                                <ItemTemplate>
