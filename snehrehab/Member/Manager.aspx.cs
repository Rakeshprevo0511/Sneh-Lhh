...
namespace snehrehab.Member
{
    ...
    {
        int _loginID = 0; int managerid = 0; public string _headerText = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (managerid > 0) { _headerText = "Edit Management Detail"; } else { _headerText = "Add Management Detail"; }
            if (!IsPostBack)
            {
                if (managerid > 0)
                {
        ...
        private void LoadData()
        {
            ...
            SnehDLL.Management_Dll RD = RB.Get(managerid);
            ...
            DataTable dt = B.Get_CerData(2, 0, managerid, 0);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnSave_Click(Object sender, EventArgs e)
        {
            ...
            SnehBLL.Management_Bll RB = new SnehBLL.Management_Bll();
            SnehDLL.Management_Dll RD = new SnehDLL.Management_Dll();
            RD.ManagerID = managerid;
            ...
            if (i > 0)
            {
                ...
                if (managerid > 0)
                {
                    Session[DbHelper.Configuration.messageTextSession] = "Management data updated successfully...";
                    Session[DbHelper.Configuration.messageTypeSession] = "1";
                    Response.Redirect(ResolveClientUrl("/Member/ViewList.aspx"), true);
                }
                else
                {
                    Session[DbHelper.Configuration.messageTextSession] = "Management data added successfully...";
                    Session[DbHelper.Configuration.messageTypeSession] = "1";
                    Response.Redirect(ResolveClientUrl("/Member/Manager.aspx"), true);
                }
            }
            else
            {
