<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="PreConsultationView.aspx.cs" Inherits="snehrehab.Reports.PreConsultationView" %>
        ...
        <div class="grid-content">
            ...
            <asp:GridView ID="ReportGV" runat="server" CssClass="table table-bordered" 
                ...
                <asp:TemplateField HeaderText="ACTION"><ItemTemplate>
                    ...
                    <%# SessionDownloadRptLink(Eval("UniqueID").ToString(), Eval("IsUpdated").ToString()) %>
