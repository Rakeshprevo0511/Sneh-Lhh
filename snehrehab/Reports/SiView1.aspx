<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="SiView1.aspx.cs" Inherits="snehrehab.Reports.SiView1" %>
        ...
        <div class="grid-content">
            ...
            <asp:GridView ID="ReportGV" runat="server" CssClass="table table-bordered" 
                ...
                <asp:TemplateField HeaderText="ACTION"><ItemTemplate>
                    ...
                    <%# DownloadRptLink(Eval("UniqueID").ToString(), Eval("IsUpdated").ToString()) %>
