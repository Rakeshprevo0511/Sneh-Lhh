<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" Inherits="Reports_AccountHead" Title="" Codebehind="AccountHead.aspx.cs" %>
    ...
    <div class="grid">
        ...
        <div class="grid-content">
            <div class="formRow">
                ...
                <asp:DropDownList ID="txtAccountHead" runat="server" CssClass="chzn-select span4"></asp:DropDownList>
                </div>
            ...
            <asp:GridView ID="ReportGV" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="custome-pagination"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ACCOUNT"><ItemTemplate><%#Eval("HeadName").ToString()%></ItemTemplate></asp:TemplateField>
                    <asp:BoundField HeaderText="DESCRIPTION" DataField="cDescription" />
                    <asp:TemplateField HeaderText="AMOUNT"><ItemTemplate><%#Eval("CreditAmt")%></ItemTemplate><HeaderStyle Width="75px"/></asp:TemplateField>
