<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" Inherits="Reports_PatientAccount" Title="" Codebehind="PatientAccount.aspx.cs" %>
    ...
    <div class="grid">
        ...
        <div class="grid-content">
            <div class="formRow">
                ...
                <asp:DropDownList ID="txtPatient" runat="server" CssClass="chzn-select span4"></asp:DropDownList>
                </div>
            ...
            <asp:GridView ID="ReportGV" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="custome-pagination"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="NARRATION"><ItemTemplate><%#Eval("Narration")%></ItemTemplate></asp:TemplateField>
                    <asp:TemplateField HeaderText="AMOUNT"><ItemTemplate><%#Eval("DebitAmt")%></ItemTemplate></asp:TemplateField>
