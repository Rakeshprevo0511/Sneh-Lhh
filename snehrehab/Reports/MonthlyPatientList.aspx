<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" CodeBehind="MonthlyPatientList.aspx.cs" Inherits="snehrehab.Reports.MonthlyPatientList" %>
...
<div class="grid">
        <div class="grid-title">
            <div class="pull-left">
                Monthly Patient List Report :</div>
        ...
        <div class="grid-content">
            <div class="formRow">
                ...
                <asp:LinkButton ID="btnExport" runat="server" CssClass="btn btn-danger" 
                        OnClick="btnExport_Click" Visible="true">Export</asp:LinkButton>
                </div>
            </div>
            <div class="clearfix">
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" style="margin: 0px;">
                        Monthly Patient List Report</h5>
                </div>
