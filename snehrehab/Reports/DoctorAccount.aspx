<%@ Page Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true" Inherits="Reports_DoctorAccount" Title="" Codebehind="DoctorAccount.aspx.cs" %>
    ...
    <div class="grid">
        ...
        <div class="grid-content">
            <div class="formRow">
                ...
                <asp:DropDownList ID="txtDoctor" runat="server" CssClass="chzn-select span4"></asp:DropDownList>
                </div>
            ...
            <asp:GridView ID="ReportGV" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="custome-pagination"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ACCOUNT"><ItemTemplate><%#Eval("PreFix").ToString() + " " + Eval("FullName").ToString()%></ItemTemplate></asp:TemplateField>
