<%@ Page Title="" MasterPageFile="~/Member/Site.master" Language="C#" AutoEventWireup="true" CodeBehind="PreConsultation.aspx.cs" Inherits="snehrehab.Reports.PreConsultation" %>
    ...
    <div class="grid">
        <div class="grid-title">
            ...
            <div class="pull-right">
                <a href="/Reports/ReportStatus.aspx" class="btn btn-primary">Report Status</a>
            </div>
        </div>
        <div class="grid-content">
            <div class="formRow">
                ...
                <asp:LinkButton ID="btnExport" runat="server" CssClass="btn btn-danger" OnClick="btnExport_Click">Export</asp:LinkButton>
                  <asp:LinkButton ID="btnResearch" runat="server" CssClass="btn btn-danger" OnClick="btnResearch_Click">Data Export</asp:LinkButton>
