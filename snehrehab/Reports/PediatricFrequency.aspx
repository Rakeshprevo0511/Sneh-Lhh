<%@ Page Title="" Language="C#" MasterPageFile="~/Member/Site.master" AutoEventWireup="true"
    CodeBehind="PediatricFrequency.aspx.cs" Inherits="snehrehab.Reports.PediatricFrequency" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="grid">
        <div class="grid-title">
            <div class="pull-left">
                Pediatric Frequency Report :</div>
            ...
            <div style="white-space: nowrap; overflow-x: auto;">
                <asp:GridView ID="ReportGV" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="custome-pagination"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PATIENTCOUNT" HeaderText="Frequency" SortExpression="PATIENTCOUNT" />
                        <asp:BoundField DataField="AgeYear" HeaderText="Year" SortExpression="AgeYear" />
                        <asp:BoundField DataField="AgeMonth" HeaderText="Month" SortExpression="AgeMonth" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
