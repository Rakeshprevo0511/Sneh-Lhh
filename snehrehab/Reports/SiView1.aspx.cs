...
{
    public partial class SiView1 : System.Web.UI.Page
    {
        ...
        public string GetAction(string UniqueID)
        {
            if (isSuperAdmin)
                ...
                return "<a href=\"/SessionRpt/SiRpt.aspx?record=" + UniqueID + "\">View/Edit</a> &nbsp;";
        }
        ...
        public string SessionRptLink(string _uniqueID, string _isUpdated)
        {
            ...
            if (isUpdated > 0)
            {
                return "<a href=\"/SessionRpt/CreateRpt.ashx?type=si&record=" + _uniqueID + "\" target=\"_blank\" class=\"btn-print btn-success\">Print</a></br>";
            }
            return "Pending</br>";
        }
        
        public string DownloadRptLink(string _uniqueID, string _isUpdated)
        {
            int isUpdated = 0; int.TryParse(_isUpdated, out isUpdated);
            if (isUpdated > 0)
            {
                return "<a href=\"/SessionRpt/DownloadCreateRpt.ashx?type=si&record=" + _uniqueID + "\" target=\"_blank\" class=\"btn-print btn-success\">Download</a></br>";
            }
            return "Pending</br>";
        }
        ...
        public string GetMailink(string _uniqueID)
        {
            ...
            {
                return "<a href=\"/Member/SendMail.aspx?type=si&record=" + _uniqueID + "\" target=\"_blank\">Send Mail</a>";
            }
            return "";
        }
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = RDB.Search(_loginID, txtSearch.Text.Trim(), _fromDate, _uptoDate, true);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.Append("</table>");
                Response.Clear();
                Response.AddHeader("Content-Disposition", "attachment;filename=" + GetCentreName(centrename) + " Search SI Report.xls");
        ...
        public string GetCentreName(string centre)
        {
            ...
            {
                return centre + " " + " Search SI  Report";
            }
            else
            {
                return " Search SI  Report";
            }
        }
