<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveA.aspx.cs" Inherits="snehrehab.LeaveA" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SnehReha :: Leave Approve</title> 
</head>
<body>
    ...
    <asp:Panel ID="pnlSuccess" runat="server" Visible="false">
        <div style="width: 100%; max-width: 500px; margin: 0 auto; border: 3px solid #01c503;
            ...
            padding: 20px;">
            <div style="text-align: center; margin-top: -70px;">
                <img src="/images/leave_approved.png" alt="" style="background: #FFF;padding-left: 5px;padding-right: 5px;" />
            </div>
            <br />
